        ...
        <Paper
          ...
          sx={{
            ...
            backgroundColor: alpha(
              elegantThemeWithOldColors.palette.background.paper,
              0.95
            ),
            backdropFilter: "blur(8px)",
            boxShadow: `0 1px 3px ${alpha(
              elegantThemeWithOldColors.palette.text.primary,
              0.1
            )}`,
          }}
        >
          <Container maxWidth="xl">
            ...
            >
              ...
              >
                <Box
                  ...
                  src="/MomUni.svg"
                  alt="MomUni"
                  sx={{ height: { xs: 28, sm: 32, md: 36 }, mr: 1 }}
                />
                <Typography
                  variant="h5"
                  component="div"
                ...
                {navItems.map((item) => (
                  <MuiLink
                    ...
                    sx={{
                      ...
                      color: isLinkActive(item.activePaths)
                        ? "primary.main"
                        : "text.primary",
                      fontSize: "0.9rem",
                      padding: "6px 10px",
                      ...
                      "&:hover": {
                        color: "primary.dark",
                        backgroundColor: alpha(
                          elegantThemeWithOldColors.palette.primary.light,
                          0.25
                        ),
                      },
                    }}
                  ...
                  sx={{
                    ...
                    "&:hover": {
                      ...
                      boxShadow: `0 1px 4px ${alpha(
                        elegantThemeWithOldColors.palette.primary.dark,
                        0.4
                      )}`,
                    },
                  }}
            ...
            <Box
              sx={{
                ...
                gridTemplateColumns: {
                  xs: "1fr",
                  sm: "1fr minmax(170px, auto)",
                },
                alignItems: "center",
                gap: { xs: 1.5, sm: 2 },
                py: 1.5,
                borderTop: `1px solid ${alpha(
                  elegantThemeWithOldColors.palette.divider,
                  0.7
                )}`,
              }}
            >
